    ...
    <section ref={sectionRef} className="w-full relative min-h-screen bg-ink" id="testimonials">
      ...
      >
        ...
        <a
          ...
          className="relative z-10 inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur-md text-ivory transition-all mb-6 pointer-events-auto group cursor-pointer shadow-lg"
        >
          ...
          <span className="text-xs text-gold group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform">↗</span>
        </a>
        
        <div className="relative z-10 font-body text-xs uppercase tracking-[0.2em] text-gold mb-4 text-center flex items-center gap-4">
           <span className="w-8 h-px bg-gold/50"></span>
           KIND WORDS
           <span className="w-8 h-px bg-gold/50"></span>
        </div>
        
        <h2 className="relative z-10 font-display text-[clamp(2.5rem,5vw,4.5rem)] text-ivory text-center leading-[1.1] max-w-2xl mb-6 drop-shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center gap-3.5 pointer-events-auto">
          <Link href="/inquire" className="font-body text-xs uppercase tracking-[0.2em] text-ink bg-ivory hover:bg-gold px-7 py-3.5 transition-colors shadow-md font-semibold">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="font-body text-xs uppercase tracking-[0.2em] text-ivory/90 hover:text-ivory border border-ivory/30 hover:border-ivory px-6 py-3.5 transition-colors backdrop-blur-sm flex items-center gap-2"
          >
          ...
          {testimonials.map((t, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center text-center max-w-[40ch] p-8 md:p-12 backdrop-blur-xl bg-ink/50 border border-ivory/15 shadow-2xl rounded-sm hover:scale-[1.02] transition-transform duration-500">

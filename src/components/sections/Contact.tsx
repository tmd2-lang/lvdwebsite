...
export default function Contact() {
  return (
    <section className="w-full bg-ivory py-12 md:py-24 px-4 sm:px-6 md:px-12" id="contact">
      <div className="max-w-[1440px] mx-auto relative rounded-[2rem] md:rounded-[3rem] overflow-hidden min-h-[500px] md:min-h-[620px] flex flex-col items-center justify-center text-center p-8 sm:p-12 md:p-20 shadow-2xl border border-ink/10 group">
        
        {/* Background Floral Image with Cinematic Overlay */}
        <div className="absolute inset-0 w-full h-full -z-10 overflow-hidden bg-ink">
          <img 
            src="/gallery/Amber & Kendall Wedding/Amber&KendallFlowerShot2.jpeg" 
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-ink/90 via-ink/65 to-ink/40 backdrop-blur-[1px]" />
        </div>
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-ivory/10 backdrop-blur-md border border-ivory/20 mb-8">
          ...
          <span className="font-body text-[10px] md:text-xs uppercase tracking-[0.25em] text-ivory/90 font-medium">
            Let's Begin
          </span>
        </div>
